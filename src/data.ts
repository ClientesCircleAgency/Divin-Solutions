...
export const capabilities: Capability[] = [
  ...
  },
  {
    ...
    specs: [
      ...
      },
      {
        ...
        items: ["Generators from 15kVA to mega-power", "Site distribution boards", "Diesel, hybrid and solar lighting towers"],
      },
      {
  ...
  },
  {
    ...
    bullets: [
      "Road diesel, agricultural diesel and HVO supply",
    ...
    specs: [
      {
        ...
        items: ["Agricultural diesel", "Road diesel", "Green diesel / HVO", "Direct refuelling into generators and machinery tanks"],
      },
      {
...
export const constructionServices: ConstructionService[] = [
  {
    ...
    metrics: ["EUR 285,850 lump sum", "Immediate start after award", "Integrated logistics coordination", "Focus on efficiency and safety"],
  ...
  },
  {
    ...
    metrics: ["EUR 334,492 package value", "22.99% of total project value", "Excavation reference: EUR 12.50/m3", "Concrete C40 reference: EUR 224.80/m3", "Steel reinforcement reference: EUR 1,550/t", "Concrete C40 cost: EUR 55,013", "Excavation cost: EUR 14,283", "Precast walls cost: EUR 25,796", "Reinforcement cost: EUR 18,600", "Other works: EUR 219,800"],
  ...
  },
  {
    ...
    metrics: ["EUR 82,479 package value", "5.67% of total project value", "Concrete C40: 41.05% / EUR 33,855", "Steel rebar: 28.30% / EUR 23,343", "Other works: 30.65% / EUR 25,281", "Technical precision", "Eurocode standards"],
  ...
  },
  {
    ...
    scope: ["Wastewater pipework from 160mm to 250mm up to 3m depth", "Process wastewater network from 110mm to 160mm", "38 floor drains and channels FD-1 to FD-4", "15 inspection chambers and 11 precast manholes", "Stormwater pipework from 160mm to 500mm at multiple depths", "96.45m longitudinal gravel drains", "142.66m concrete pipe encasement", "15 gullies and 28 stormwater chambers/manholes", "ACO MULTILINE channels S150, S300 and 200", "ACO Oleopator NS200 oil separators", "CCTV inspection"],
    metrics: ["EUR 260,582 package value", "17.92% of total project value", "Pipework 250mm reference: EUR 89.35/m", "Pipework 500mm reference: EUR 105-173/m", "Oil separator installation: EUR 20,500/unit", "2 oil separators", "Environmental protection"],
  ...
  },
  {
    ...
    metrics: ["EUR 114,872 package value", "7.90% of total project value", "Fire network extension: 458m", "Potable water extension: 221m", "Fire network 200mm <2.5m: EUR 176.10/m", "Fire network 200mm <3.0m: EUR 209.12/m", "Potable water 63mm: EUR 69.25/m", "Anchorage blocks provisional: EUR 2,500"],
  ...
  },
  {
    ...
    metrics: ["EUR 281,864 package value", "19.38% of total project value", "Low-voltage infrastructure: 900m", "Telecommunications: 800m", "Earthing protection: 536m", "67+ boxes/chambers", "Complex chambers and security/mobility bases"],
  ...
  },
  {
    ...
    scope: ["Industrial refuelling-system infrastructure", "3 fuel tanks, 2.5m diameter x 6.5m", "Anti-flotation measures for structural stability", "510m+ industrial pipework from DN30 to DN100", "Pipework for safe fuel transfer", "Bravo B600 access chambers: 9 units", "Reinforced FOCP structural slabs for equipment support"],
    metrics: ["EUR 61,552 package value", "4.23% of total project value", "Total pipework: 510m+", "Fuel tanks: 3 units", "Containment and protection", "Safe fuel transfer"],
  ...
  },
  {
    ...
    metrics: ["EUR 32,713 package value", "2.25% of total project value", "838m+ total kerbs", "100% compliance objective", "Standard kerbs: EUR 30,608", "Dropped kerbs: EUR 1,606", "Tactile paving: EUR 498", "Accessibility compliance"],
